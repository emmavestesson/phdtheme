               ...
               base_family = "")
  {
    ...
    ggthemes::theme_foundation(base_size = base_size, base_family = base_family) %+replace%
      theme(
        ...
        axis.text = element_text(size = 2 * ggplot2:::.pt, colour = darkgrey),
        axis.text.x = element_text(angle = -45, hjust = -0.08),
        axis.text.y = element_text(
          size = 2 * ggplot2:::.pt,
          margin = margin(r = 5, unit = 'mm')
        ),
        axis.ticks = element_line(colour = lightgrey, size = 0.5 * ggplot2:::.pt),
        ...
        legend.text = element_text(size = rel(0.8), face = 'plain', colour = darkgrey),
